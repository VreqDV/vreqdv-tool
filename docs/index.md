...
5. The project will now contain a directory titled 'VReqDV/specifications', which has the model template specifications for the Bowling Alley scene. These can be modified according to the user’s requirements. Sample specifications can also be found [here].
